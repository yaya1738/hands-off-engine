#!/usr/bin/env python3
"""
Legacy approval queue compatibility layer.

The queue remains available for reading and for recording legacy approval
transitions, but it is no longer an execution authority. External callers
must route execution through the governed Factory authority path.
"""
...
class ApprovalQueue:
    ...
    def execute_approved(self, change_id: str) -> Dict:
        ...
        return {
            ...
            "message": (
                "Approval recorded, but legacy execution is disabled. "
