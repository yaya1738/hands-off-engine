...
class FactoryChangeValidation:
    ...
    def validate_action_router_integration(self):
        ...
        checks = {
            "router_import": "FactoryActionRouter" in text,
            "router_initialized": "self.action_router = FactoryActionRouter" in text,
            "improvement_gateway": "trigger_improvement_pipeline" in text,
