...
def call_github_copilot(prompt: str, system_message: str = None, **kwargs) -> str:
    """
    Simple function wrapper for GitHub Copilot.
    Used by tri_agent_session_runner and multi_provider.

    Note: Copilot doesn't have a direct API - this is a stub that tracks actions.
    Actual Copilot interactions happen through editor extensions.

    Returns placeholder response.
    """
    # Copilot runs through editor, not API
    # This is a tracking stub for the tri-agent session runner
    return "[GitHub Copilot: Executes via editor extension - no direct API]"
