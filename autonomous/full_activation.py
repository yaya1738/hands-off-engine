...
class FullActivation:
    ...
    def activate_intelligence_gathering(self) -> Dict:
        ...
        # 3. Infrastructure map - current state
        print("\n[3] Infrastructure Map - State Recording...")
        success, output = self._run_module('infrastructure_map', ['record'])
        results['infrastructure_map'] = {'success': success, 'output': output[:100]}
        print(f"    {'✓' if success else '✗'} Infrastructure Map")
