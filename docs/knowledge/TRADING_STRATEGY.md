...
(Using "Tier" to avoid confusion with "Level 2" order book data)
...
**Tier 2: Working Capital (Limit Order Collateral)**
...
**Tier 3: Locked Capital (Filled Positions)**
- Actually holding YES/NO tokens
- Locked until sell/resolution

**IMPORTANT TERMINOLOGY:**
- "Level 2" = Order book data (all bids/asks at every price) - MARKET DATA
- "Tier 2" = Working capital in limit orders - CAPITAL ALLOCATION
