...
The hosted service was verified by GitHub Actions run `34112071602`, and the persisted-state contract was subsequently hardened so ephemeral runners share queue/completion/attempt evidence.
